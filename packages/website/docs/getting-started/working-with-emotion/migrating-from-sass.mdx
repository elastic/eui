...
<EuiTable>
  ...
  <EuiTableRow>
    ...
    <EuiTableRowCell>Deprecated. Use `<EuiTitle />` instead (strongly recommended)<br/> If absolutely necessary, you may reach into the EuiTitle component via `import { euiTitle } from '@elastic/eui/es/components/title/title.styles.js';`, <br />but this is generally not recommended as deep imports are not part of the public API</EuiTableRowCell>
  </EuiTableRow>
  <EuiTableRow>
