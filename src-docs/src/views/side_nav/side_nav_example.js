  ...
  sections: [
    {
      ...
      text: (
        <div>
          <p>
            <EuiCode>SideNav</EuiCode> is a responsive menu system that usually sits on the left
            side of a page layout. It will expand to the width of its container. This is the menu
            that is used on the left side of the page you are currently looking at.
          </p>

          <p>
            Configure the content of a <EuiCode>SideNav</EuiCode> by passing in an{' '}
            <EuiCode>items</EuiCode> prop. Refer to the source code for an example of this data
            structure&rsquo;s anatomy.
          </p>
        </div>
      ),
      props: { EuiSideNav },
