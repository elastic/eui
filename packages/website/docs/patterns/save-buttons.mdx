...
import figmaSaveButtonsWhenShouldIUseASaveButton from '!url-loader!./assets/save-buttons_when-should-i-use-a-save-button.svg';
import figmaSaveButtonsHowDoIStyleIt from '!url-loader!./assets/save-buttons_how-do-i-style-it.svg';
import figmaSaveButtonsAvoidUsingTheDefaultFillForTheButton from '!url-loader!./assets/save-buttons_avoid-using-the-default-fill-for-the-button.svg';
import figmaSaveButtonsAvoidUsingTheSuccessColorVariant from '!url-loader!./assets/save-buttons_avoid-using-the-success-color-variant.svg';
import figmaSaveButtonsAvoidSizingTheButtonDifferentlyThanSurroundingButtonsOrFormFields from '!url-loader!./assets/save-buttons_avoid-sizing-the-button-differently-than-surrounding-buttons-or-form-fields.svg';
import figmaSaveButtonsConsiderIfAnIconIsNecessary from '!url-loader!./assets/save-buttons_consider-if-an-icon-is-necessary.svg';
...
<FigmaAsset
  url="https://www.figma.com/file/rTQpimg0zLB8RP1TWngNTk/Save-Create-Buttons-%5B179%5D?type=design&node-id=738%3A183&mode=design&t=mG6gI94ediVlaPgh-1"
  src={figmaSaveButtonsWhenShouldIUseASaveButton}
  title="When should I use a 'Save button'?"
/>
...
* Include the noun in the label.
* Avoid using icons where possible

<FigmaAsset
  url="https://www.figma.com/file/rTQpimg0zLB8RP1TWngNTk/Save-Create-Buttons-%5B179%5D?type=design&node-id=562%3A3874&mode=design&t=CLKS3D49G3Au83kb-1"
  src={figmaSaveButtonsHowDoIStyleIt}
...
<FigmaAsset
  url="https://www.figma.com/file/rTQpimg0zLB8RP1TWngNTk/Save-Create-Buttons-%5B179%5D?type=design&node-id=562%3A3964&mode=design&t=CLKS3D49G3Au83kb-1"
  src={figmaSaveButtonsAvoidUsingTheDefaultFillForTheButton}
  title="Avoid using the default fill for the button"
/>
...
<FigmaAsset
  url="https://www.figma.com/file/rTQpimg0zLB8RP1TWngNTk/Save-Create-Buttons-%5B179%5D?type=design&node-id=562%3A3994&mode=design&t=CLKS3D49G3Au83kb-1"
  src={figmaSaveButtonsAvoidUsingTheSuccessColorVariant}
  title="Avoid using the success color variant"
/>
...
<FigmaAsset
  url="https://www.figma.com/file/rTQpimg0zLB8RP1TWngNTk/Save-Create-Buttons-%5B179%5D?type=design&node-id=562%3A3892&mode=design&t=CLKS3D49G3Au83kb-1"
  src={figmaSaveButtonsAvoidSizingTheButtonDifferentlyThanSurroundingButtonsOrFormFields}
  title="Avoid sizing the button differently than surrounding buttons or form fields"
/>
...
<FigmaAsset
  url="https://www.figma.com/file/rTQpimg0zLB8RP1TWngNTk/Save-Create-Buttons-%5B179%5D?type=design&node-id=562%3A4023&mode=design&t=CLKS3D49G3Au83kb-1"
  src={figmaSaveButtonsConsiderIfAnIconIsNecessary}
  title="Consider if an icon is necessary"
/>
