...
Use the title prop to explain the [problem](./error_writing.mdx#1-the-problem).

Use paragraphs to explain the [cause](./error_writing.mdx#2-the-cause) and the [recommendation](./error_writing.mdx#3-the-recommendation).
