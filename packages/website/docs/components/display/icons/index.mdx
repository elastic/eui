...
import iconSynonymsSource from '!raw-loader!./icon_synonyms';

<Demo scope={{ iconTypes, filterIconTypes, iconSynonyms }} extraFiles={{ 'icon_types.ts': iconTypesSource, 'icon_filter.ts': iconFilterSource, 'icon_synonyms.ts': iconSynonymsSource }}>
  ```tsx
