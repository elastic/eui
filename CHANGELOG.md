...
- Added `moon` glyph to `EuiIcon` ([#1850](https://github.com/elastic/eui/pull/1851))
- Added `logo_azure` and `logoAzureMono` glyph to `EuiIcon` ([#1850](https://github.com/elastic/eui/pull/1851))
