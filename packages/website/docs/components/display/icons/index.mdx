...
import { filterIconTypes } from './icon_filter';
import iconFilterSource from '!raw-loader!./icon_filter';
import {
  typeToPathMapIconTypes as iconTypes,
  typeToPathMapSynonyms as iconSynonyms,
} from '../../../../../eui/src/components/icon/icon_map';

<Demo scope={{ iconTypes, filterIconTypes, iconSynonyms }} extraFiles={{ 'icon_filter.ts': iconFilterSource }}>
  ```tsx
