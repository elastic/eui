...
export default () => (
  <GuidePage title="">
    ...
    <GuideRule
      description="
        The header directs users' attention to the task, and the body contains the
        text and components to support it.
    ...
    >
      <GuideRuleExample
        ...
        type="do"
        text="
          Do. Pare down the content to just the essential
          elements. Match the header and button text.
        "
      >
        <div style={{ textAlign: 'center' }}>
