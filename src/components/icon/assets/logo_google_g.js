  ...
  <svg
    ...
    <g fill="none" fillRule="evenodd">
      <g transform="translate(15.955 13.087)">
        <mask id="logo_google_g_oh1-b" fill="#fff">
          <use xlinkHref="#logo_google_g_oh1-a" />
        </mask>
        <path
          fill="#4285F4"
          fillRule="nonzero"
          mask="url(#logo_google_g_oh1-b)"
          d="M.001 15.006h15.318V.014H.001z"
        />
      </g>
      <g transform="translate(1.613 19.003)">
        <mask id="logo_google_g_oh1-d" fill="#fff">
          <use xlinkHref="#logo_google_g_oh1-c" />
        </mask>
        <path
          fill="#34A853"
          fillRule="nonzero"
          mask="url(#logo_google_g_oh1-d)"
          d="M.084 12.956h24.819V.031H.084z"
        />
      </g>
      <g transform="translate(0 8.784)">
        <mask id="logo_google_g_oh1-f" fill="#fff">
          <use xlinkHref="#logo_google_g_oh1-e" />
        </mask>
        <path
          fill="#FBBC04"
          fillRule="nonzero"
          mask="url(#logo_google_g_oh1-f)"
          d="M0 14.384h7.028V.052H0z"
        />
      </g>
      <g transform="translate(1.613)">
        <mask id="logo_google_g_oh1-h" fill="#fff">
          <use xlinkHref="#logo_google_g_oh1-g" />
        </mask>
        <path
          fill="#EA4335"
          fillRule="nonzero"
          mask="url(#logo_google_g_oh1-h)"
