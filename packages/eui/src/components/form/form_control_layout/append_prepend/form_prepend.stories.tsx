...
import {
  EuiFormPrepend,
  type EuiFormPrependProps,
} from './form_append_prepend';

const meta: Meta<EuiFormPrependProps> = {
  title: 'Forms/EuiForm/EuiFormControlLayout/Subcomponents/EuiFormPrepend',
  component: EuiFormPrepend,
  argTypes: {
    label: { control: 'text' },
...
export default meta;
type Story = StoryObj<EuiFormPrependProps>;
