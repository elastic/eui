import figmaEmptyPromptAnatomy from '!url-loader!./assets/empty-prompt_anatomy.svg';
...
<FigmaAsset
  url="https://www.figma.com/file/FHys7gLzyvD1gc9DrJM6D8/Elastic-UI--Borealis-?node-id=17578-2472"
  src={figmaEmptyPromptAnatomy}
