...
Use **EuiFormFieldset** for groups of related controls where the individual labels for each control do not provide a sufficient description and an additional group level description is needed ([WCAG spec](https://www.w3.org/WAI/WCAG21/Techniques/html/H71)).
