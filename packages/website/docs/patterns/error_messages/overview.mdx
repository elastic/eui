...
- [400: Bad request](./error_examples.mdx#400-bad-request)
- [401: Unauthorized](./error_examples.mdx#401-unauthorized)
- [403: Forbidden](./error_examples.mdx#403-forbidden)
- [404: Not found](./error_examples.mdx#404-not-found)
- [408: Request timeout](./error_examples.mdx#408-request-timeout)
- [410: Gone](./error_examples.mdx#410-gone)
- [429: Too many requests](./error_examples.mdx#429-too-many-requests)
- [500: Internal server error](./error_examples.mdx#500-internal-server-error)
- [502: Bad gateway](./error_examples.mdx#502-bad-gateway)
- [503: Service unavailable](./error_examples.mdx#503-service-unavailable)
- [504: Gateway timeout](./error_examples.mdx#504-gateway-timeout)
- [507: Insufficient storage](./error_examples.mdx#507-insufficient-storage)
...
- [Content patterns](../../content/overview.mdx)
