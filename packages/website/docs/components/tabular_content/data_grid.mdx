...
Please check the props tab in the example above for more explanation on the lower level object types. The majority of the types are defined in the [/datagrid/data\_grid\_types.ts(opens in a new tab or window)](https://github.com/elastic/eui/tree/main/src/components/datagrid/data_grid_types.ts) file.
...
[**gridStyle**](/docs/tabular-content/data-grid-style-display#grid-style)
...
[**inMemory**](/docs/tabular-content/data-grid-advanced#data-grid-in-memory)
...
```
// Will try to autodectect schemas and do sorting and pagination in memory.
inMemory={{ level: 'sorting' }}
```
...
[**leadingControlColumns**](/docs/tabular-content/data-grid-schema-columns#control-columns)
...
[**ref**](/docs/tabular-content/data-grid-advanced#ref-methods)

 |

```
// Optional. For advanced control of internal data grid state, passes back an object of imperative API methods
ref={dataGridRef}
```
...
[**renderCellPopover**](/docs/tabular-content/data-grid/cells-and-popovers#completely-customizing-cell-popover-rendering)
...
[**cellContext**](/docs/tabular-content/data-grid/cells-and-popovers#cell-context)
...
[**renderCustomGridBody**](/docs/tabular-content/data-grid-advanced#custom-body-renderer)
...
```
// Optional; advanced usage only. This render function is an escape hatch for consumers who need to opt out of virtualization or otherwise need total custom control over how data grid cells are rendered.
...
[**renderFooterCellValue**](/docs/tabular-content/data-grid-schema-columns#footer-row)
...
[**rowHeightsOptions**](/docs/tabular-content/data-grid-style-display#row-heights-options)
...
[**schemaDetectors**](/docs/tabular-content/data-grid-schema-columns#schemas)
...
[See Data Grid Schemas for full details.](/docs/tabular-content/data-grid-schema-columns#schemas)
...
[**toolbarVisibility**](/docs/tabular-content/data-grid-toolbar#toolbar-visibility)
...
[**trailingControlColumns**](/docs/tabular-content/data-grid-schema-columns#control-columns)
...
```
// Optional. For advanced control of the underlying react-window virtualization grid.
virtualizationOptions={{
