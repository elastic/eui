...
class _Axes extends PureComponent {
  render() {
        ...
        <EuiFlexItem>
          <EuiCard
            ...
            footer={cardFooterContent(
              'https://elastic.github.io/elastic-charts/?selectedKind=Axis&selectedStory=basic&full=0&addons=1&stories=1&panelRight=1&addonPanel=storybook%2Fstories%2Fstories-panel',
              `<Chart renderer="canvas" size={[undefined, 140]}>
      <Settings {...SETTINGS} />
      <Axis
        id={getAxisId('bottom-axis')}
      ...
      />
        ...
        <EuiFlexItem>
          <EuiCard
            ...
            description="Example of a card's description. Stick to one or two sentences."
            footer={cardFooterContent(
              'https://elastic.github.io/elastic-charts/?selectedKind=Axis&selectedStory=customizing%20domain%20limits%20%5Bonly%20one%20bound%20defined%5D&full=0&addons=1&stories=1&panelRight=1&addonPanel=storybook%2Fstories%2Fstories-panel',
              `<Chart renderer="canvas" size={[undefined, 140]}>
...
export const Axes = withTheme(_Axes);
