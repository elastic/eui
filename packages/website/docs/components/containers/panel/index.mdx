---
slug: /containers/panel
id: containers_panel
---

# Panel

**EuiPanel** is a building block component. Use it as a layout helper for containing content. It is also commonly used as a base for other larger components like [EuiPage](../../templates/page_template/overview.mdx), [EuiPopover](../popover.mdx) and [EuiCard](../card.mdx).
...
Using **EuiPanel** in an [EuiFlexItem](../../layout/flex/flex_item.mdx#panels-grow-vertically-to-fill-flex-items) will always grow its height to match. This is great for rows of panels. However, you can also turn this feature off by setting `grow={false}`.
