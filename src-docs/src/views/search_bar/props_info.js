  ...
  EuiSearchBar: {
    __docgenInfo: {
      props: {
        ...
        query: {
          description: 'Sets the query on the search bar. Should only be used when the query is controlled and ' +
    ...
    __docgenInfo: {
      ...
      props: {
        ...
        execute: {
          ...
          type: { name: 'static (query: #Query | string, items: Object[], options?: #ExecuteQueryOptions) => Object[]' }
        },
        toESQuery: {
          description: 'Builds and returns an Elasticsearch query object out of the given query',
          type: { name: 'static (query: #Query | string, options?: #ToESQueryOptions) => ESQuery' }
        }
      }
    }
  },
  ...
  ExecuteQueryOptions: {
    __docgenInfo: {
      ...
      props: {
        ...
        explain: {
          description: 'When `true` each item in the returned array will have a `__explain` field explaining ' +
