...
* **Delete** N things — Permanently deletes data. Opposite: Create. Not to be confused with Remove.  
...
Buttons adjacent to a primary CTA should be **tertiary**, presented as **
empty** buttons. Tertiary actions are less consequential, exiting the flow or not changing data.
