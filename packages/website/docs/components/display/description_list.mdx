...
For advanced usage, column width strings also accept [CSS grid special units, sizing, keywords, and sizing functions(opens in a new tab or window)](https://css-tricks.com/snippets/css/complete-guide-grid/#aa-special-units-functions).
