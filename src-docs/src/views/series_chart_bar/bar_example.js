...
export const XYChartBarExample = {
  ...
  intro: (
    <Fragment>
      ...
      <EuiSpacer size="l" />
      <p>
        You can use <EuiCode>EuiSeriesChart</EuiCode> with <EuiCode>EuiBarSeries</EuiCode> to
      ...
      <EuiSpacer size="l" />
      <p>
        You should specify <EuiCode>EuiSeriesChart</EuiCode> prop <EuiCode>xType=&quot;ordinal&quot;</EuiCode>
      ...
      <EuiSpacer size="l" />
      <p>
        You can configure the Y-Axis scale type <EuiCode>yType</EuiCode> of <EuiCode>EuiSeriesChart</EuiCode>
