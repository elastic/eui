  ...
  EuiBasicTableContainer: {
    __docgenInfo: {
      props: {
        ...
        message: {
          description:
            'A message to be shown by the table. When set, the message will be displayed instead of ' +
        ...
        error: {
          description:
            'An error message to be shown by the table. Takes precedence over the configured `message` ' +
            'or `items`',
          required: false,
          type: { name: 'string' },
        },
  ...
  Search: {
    __docgenInfo: {
      ...
      props: {
        ...
        onChange: {
          description:
            'Callback for when the search bar value changes. By default this will prevent in-memory searching. Return `true` to allow in-memory searching.',
          required: false,
          type: { name: 'function' },
        },
      },
