...
import figmaTourExplainWhyTheActionsYouWantUsersToPerformAreUseful from './assets/tour_explain-why-the-actions-you-want-users-to-perform-are-useful.webp';
import figmaTourKeepTheToneConversationalAndFriendly from './assets/tour_keep-the-tone-conversational-and-friendly.webp';
import figmaTourAllowUsersToEndAndRestartTheTourAtAnyTime from './assets/tour_allow-users-to-end-and-restart-the-tour-at-any-time.webp';
