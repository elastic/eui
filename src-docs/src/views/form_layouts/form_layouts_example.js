  ...
  sections: [
    {
      ...
      text: (
        <p>
          ...
          labels, help text, and error text. Use the <EuiCode>EuiForm</EuiCode> component to group{' '}
    ...
    },
    {
      ...
      text: (
        <p>
          Form elements will automatically flex to a max-width of <EuiCode>400px</EuiCode>. You can
          optionally pass the <EuiCode>fullWidth</EuiCode> prop to both individual field and row
          components to expand to their container. This should be done rarely and usually you will
          only need it for isolated controls like search bars and sliders.
        </p>
      ),
      props: {
        EuiFieldSearch,
    ...
    },
    {
      ...
      text: (
        <p>
          Forms can be placed within <EuiCode>EuiPopover</EuiCode> and should scale accordingly.
        </p>
      ),
      source: [
        {
    ...
    },
    {
      ...
      text: (
        <p>
          ...
          <EuiCode>grow=false</EuiCode> on any of the items you want to collapse (like this button).
          Note that the button FormRow component also requires an additional prop because it&rsquo;s
          missing a label.
        </p>
      ),
      source: [
    ...
    },
    {
      ...
      text: (
        <p>
          When you need to make a field smaller, always apply the width to the FlexItem, not the
          input. The input inside will resize as needed.
        </p>
      ),
      demo: <InlineSizing />,
    },
    {
      ...
      text: (
        <p>
          Because forms auto-size to their wrapping elements, it means you can do fun things with
          them like stuff them in popovers and they&rsquo;ll still work perfectly.
        </p>
      ),
      demo: <InlinePopover />,
    },
