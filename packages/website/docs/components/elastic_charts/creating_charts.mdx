...
EUI provides utilities and documentation for working with [Elastic Charts(opens in a new tab or window)](https://elastic.github.io/elastic-charts), an open source charting library also created and maintained by Elastic.
...
EUI provides a plugin utility for ease of pulling in the correct theme object depending on the current Kibana theme. Learn more from this [readme(opens in a new tab or window)](https://github.com/elastic/kibana/tree/main/src/plugins/charts).
