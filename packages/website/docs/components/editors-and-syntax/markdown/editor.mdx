...
export default () => {
  ...
  const [isToolbarRightCustom, setIsToolbarRightCustom] = useState(false);

  const onReadOnlyChange = (e) => {
    setIsReadOnly(e.target.checked);
  };

  const onToolbarRightCustomChange = (e) => {
    setIsToolbarRightCustom(e.target.checked);
  };
  ...
  return (
    <>
      <EuiMarkdownEditor
        ...
        toolbarProps={{
          right: isToolbarRightCustom ? EuiMarkdownEditorHelpButton : undefined
        }}
      />
      <EuiSpacer size="s" />
      <EuiFlexGroup alignItems="center">
        <EuiFlexItem grow={true}>
          <EuiFlexGroup>
            ...
            <EuiFlexItem>
              <EuiSwitch
                label="Custom Toolbar Right Slot"
                checked={isToolbarRightCustom}
                onChange={onToolbarRightCustomChange}
              />
            </EuiFlexItem>
          </EuiFlexGroup>
        </EuiFlexItem>
