...
**EuiCard** is a legacy wrapper component. For new implementations, we recommend using the [Card layouts pattern](/docs/patterns/layouts/card-layouts) which provides more flexibility and better accessibility.
...
## Migration to Card layouts pattern

If you're currently using `EuiCard`, consider migrating to the [Card layouts pattern](/docs/patterns/layouts/card-layouts) for better flexibility and consistency:
