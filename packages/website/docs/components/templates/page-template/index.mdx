...
import contentSvgSource from '!raw-loader!./content_paragraph.svg';
import sideNavSvgSource from '!raw-loader!./content_side_nav.svg';
import centerSvgSource from '!raw-loader!./content_center.svg';
```

<Demo scope={{ contentSvg }} extraFiles={{ 'content_paragraph.svg': contentSvgSource }}>
  ```tsx
  ...
  import contentSvg from './content_paragraph.svg';
...
<Demo
  scope={{ contentSvg, sideNavSvg }}
  extraFiles={{
    'content_paragraph.svg': contentSvgSource,
    'content_side_nav.svg': sideNavSvgSource
  }}
>
```tsx
import React from 'react';
...
import contentSvg from './content_paragraph.svg';
import sideNavSvg from './content_side_nav.svg';
...
<Demo
  scope={{ centerSvg, sideNavSvg }}
  extraFiles={{
    'content_center.svg': centerSvgSource,
    'content_side_nav.svg': sideNavSvgSource
  }}
>
```tsx
...
import centerSvg from './content_center.svg';
import sideNavSvg from './content_side_nav.svg';
