...
Label [buttons](../../components/navigation/buttons/button.mdx) with their action. Don't use Yes, OK, or Confirm when you can use a verb phrase instead.
...
Be sure to read the [full button guidelines](../../components/navigation/buttons/guidelines.mdx).
...
The best empty state lets users know what is happening, why it is happening, and what to do about it. Here are four types of frequently used [empty prompts](../../components/display/empty-prompt/index.mdx).
...
Be sure to read the [full empty prompt guidelines](../../components/display/empty-prompt/index.mdx#guidelines).

## Labels

Avoid long [labels](../../components/forms/layouts/label.mdx), but don't sacrifice clarity. If needed, put additional information in help text and tooltips.
...
Use clear language for [validation](../../components/forms/validation/basic.mdx) messages.
