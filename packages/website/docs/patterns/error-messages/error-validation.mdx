...
- [error page pattern](./error-page.mdx)
- [error banner pattern](./error-banners.mdx)
- [error warning pattern](./error-warning.mdx)
...
### Error summary
Error summaries must be highly visible. Use the [EuiCallout](../../components/display/callout.mdx) component, and the props:
- `color="danger"`
- `iconType="alert"`
...
Use the [EuiFormRow](../../components/forms/form_validation/overview.mdx#EuiFormRow-prop-error) to display the error message alongside the field. Make sure the error message on the field matches the error message in the summary, so it’s obvious which field caused which error.
