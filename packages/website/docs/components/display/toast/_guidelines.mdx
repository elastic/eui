import { EuiCallOut, EuiFlexGroup, EuiFlexItem, EuiSpacer, EuiToast } from '@elastic/eui';
...
A toast should have a single action most of the time. If you need a secondary one, you can include it.
If even more actions are needed, or if the action is important enough to interrupt the user, use a modal instead.

<EuiFlexGroup gutterSize="m">
  <Guideline type="do" text="Use only one action per toast and favor a one-word label.">
    <EuiToast
      style={{ maxWidth: 300 }}
      color="success"
      title="Your report is complete"
      actionProps={{ primary: { children: 'Download' } }}
    />
  </Guideline>
  <Guideline type="dont" text="Use multiple actions. Don't align buttons in toasts to the left. This message is better in a confirmation modal.">
    <EuiToast
      ...
      color="danger"
      actionProps={{
        primary: { children: 'Cancel' },
        secondary: { children: 'Delete' },
      }}
    />
  </Guideline>
</EuiFlexGroup>
...
<EuiFlexGroup gutterSize="m">
  <Guideline type="do" text="The default icons communicate message type at a glance. Override with iconType only when a more specific icon adds clear meaning.">
     <EuiToast
        style={{ maxWidth: 300 }}
  ...
  <Guideline type="dont" text="Override the icon with something unrelated or hard to understand. It distracts from the message.">
    <EuiToast
      color="primary"
      style={{ maxWidth: 300 }}
      title="Message sent"
...
<EuiFlexGroup gutterSize="m">
  <Guideline type="do" text="Use the toast message to provide a summary and a button to link to the full content.">
    <EuiToast
      ...
      text="The maximum bucket size of 200 was exceeded."
      actionProps={{
        primary: { children: 'See the full error' },
       }}
    />
  </Guideline>
  <Guideline type="dont" text="Cram a lot of content into the small space of a toast.">
    ...
    >
      <EuiCallOut
        ...
        text="An extremely long error trace."
        color="danger"
      />
    </EuiToast>
  </Guideline>
