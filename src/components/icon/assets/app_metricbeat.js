...
const EuiIconAppMetricbeat = props => (
  <svg
    width={32}
    height={32}
    viewBox="0 0 32 32"
    ...
    />
    <path d="M21.71 11.71L20.3 10.3 18 12.57a4 4 0 0 0-2-.57 4 4 0 1 0 4 4 4 4 0 0 0-.57-2l2.28-2.29zM16 18a2 2 0 1 1 0-4 2 2 0 0 1 0 4z" />
  </svg>
);
