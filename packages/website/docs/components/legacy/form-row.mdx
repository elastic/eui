...
**EuiFormRow** is a legacy wrapper component. For new implementations, we recommend using the [Form layout pattern](/docs/patterns/forms/form-layout) which provides more flexibility and better accessibility.
