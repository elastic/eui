...
import { EuiButton, EuiButtonEmpty, EuiButtonIcon, EuiCode } from '../../../../src/components';
...
export const ButtonExample = {
  ...
  sections: [
    ...
    },
    {
      ...
      text: (
        <p>
          ...
          to the other side by passing <EuiCode>iconSide=&ldquo;right&rdquo;</EuiCode>.
        </p>
      ),
      demo: <ButtonWithIcon />,
    },
    ...
    },
    {
      ...
      text: (
        <p>
          You can also pass <EuiCode>type=&apos;ghost&apos;</EuiCode> to any of the button styles on
          this page. These should be used extremely rarely, and are only for placing buttons on top
          of dark or image-based backgrounds. A good example of their use is in the{' '}
          <EuiCode>EuiBottomBar</EuiCode> component
        </p>
      ),
      demo: <ButtonGhost />,
    },
