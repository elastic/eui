...
<EuiFlexGroup gutterSize="m">
  ...
  <Guideline type="dont" text="Use complete sentences and ending punctuation.">
    <EuiFormRow
      label="Name"
...
<EuiFlexGroup gutterSize="m">
  <Guideline type="do" text="When space is limited and the UI is very simple, you can use field labels as placeholder text. This must stay an exception.">
