...
const EuiIconLogoGoogleG = ({
  ...
  const useGeneratedId = (suffix: string) =>
    useGeneratedHtmlId({ prefix: 'logo_google_g', suffix });
  return (
    <svg
    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <g transform="translate(1.613 19.003)">
          <mask id={useGeneratedId('d')} fill="#fff">
            <use xlinkHref={`#${useGeneratedId('c')}`} />
          </mask>
          <path
            fill="#34A853"
            fillRule="nonzero"
            d="M.084 12.956h24.819V.031H.084z"
            mask={`url(#${useGeneratedId('d')})`}
          />
        </g>
        <g transform="translate(0 8.784)">
          <mask id={useGeneratedId('f')} fill="#fff">
            <use xlinkHref={`#${useGeneratedId('e')}`} />
          </mask>
          <path
            fill="#FBBC04"
            fillRule="nonzero"
            d="M0 14.384h7.028V.052H0z"
            mask={`url(#${useGeneratedId('f')})`}
          />
        </g>
        <g transform="translate(1.613)">
          <mask id={useGeneratedId('h')} fill="#fff">
            <use xlinkHref={`#${useGeneratedId('g')}`} />
          </mask>
          <path
            fill="#EA4335"
            fillRule="nonzero"
            d="M.084 12.97h24.935V.046H.084z"
            mask={`url(#${useGeneratedId('h')})`}
          />
        </g>
      </g>
    </svg>
