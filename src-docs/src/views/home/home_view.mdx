...
<EuiPageSection restrictWidth>
  ...
  <div>
    <EuiText size="xs" textAlign="center" color="subdued">
      <p>
        EUI is dual-licensed under [Elastic License 2.0](https://github.com/elastic/eui/blob/main/licenses/ELASTIC-LICENSE-2.0.md) and [Server Side Public License, v 1](https://github.com/elastic/eui/blob/main/licenses/SSPL-LICENSE.md) | Crafted with ❤️ by [<HomeFooterElasticLogo />](http://elastic.co/)
      </p>
    </EuiText>
  </div>
</EuiPageSection>
