...
Customize the read mode by passing `readModeProps`, which accepts any [**EuiButtonEmpty**](/docs/navigation/button/empty/) properties.
...
*   `editMode.formRowProps` accepts any [**EuiFormRow**](/docs/forms/layouts/row/) properties
*   `editMode.inputProps` accepts any [**EuiFieldText**](/docs/forms/text/#text-field) properties
*   `editMode.saveButtonProps` accepts any [**EuiIconButton**](/docs/navigation/button/icon/) properties
*   `editMode.cancelButtonProps` accepts any [**EuiIconButton**](/docs/navigation/button/icon/) properties
