...
export const BrandJS: FunctionComponent<React.PropsWithChildren<
  ThemeRowType
>> = ({ description }) => {
...
export const TextJS: FunctionComponent<React.PropsWithChildren<
  ThemeRowType
>> = ({ description }) => {
  const { euiTheme } = useEuiTheme();
...
export const ShadeJS: FunctionComponent<React.PropsWithChildren<
  ThemeRowType
>> = ({ description }) => {
  const { euiTheme } = useEuiTheme();
...
export const SpecialJS: FunctionComponent<React.PropsWithChildren<
  ThemeRowType
>> = ({ description }) => {
  const { euiTheme } = useEuiTheme();
