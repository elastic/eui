...
As an optional escape hatch, `ariaLiveProps` is also available and accepts any [**EuiScreenReaderLive**](/docs/utilities/accessibility#screen-reader-live-region) props.
