...
import { EuiBanner, useEuiTheme } from '@elastic/eui';
...
import { EuiBanner, EuiButtonEmpty, useEuiTheme } from '@elastic/eui';
...
```tsx interactive
import React from 'react';
import { EuiBanner, EuiSpacer, useEuiTheme } from '@elastic/eui';
