    ...
    <div className="guideSection__text">
      ...
      <EuiText grow={false}>
        <p>
          ...
          to build internal products that need to share our aesthetics. It
          distributes UI React components and static assets for use in building
          web layouts. Alongside the React components is a SASS/CSS layer that
          can be used independently on its own. If this is your first time using
          EUI you might want to read up on{' '}
      ...
      <EuiFlexGrid gutterSize="l" columns={3}>
        <EuiFlexItem>
          <EuiCard
            ...
            onClick={() => goToPage('/display/icons')}
          />
        </EuiFlexItem>
        <EuiFlexItem>
          <EuiCard
            ...
            onClick={() => goToPage('/navigation/button')}
          />
        </EuiFlexItem>
        <EuiFlexItem>
          <EuiCard
        ...
        <EuiFlexItem>
          <EuiCard
            ...
            onClick={() => goToPage('/tabular-content/tables')}
          />
        </EuiFlexItem>
        <EuiFlexItem>
          <EuiCard
        ...
        <EuiFlexItem>
          <EuiCard
            ...
            onClick={() => goToPage('/forms/form-layouts')}
          />
        </EuiFlexItem>
      </EuiFlexGrid>
      <EuiSpacer />
      <EuiText grow={false}>
        ...
        <dl>
          ...
          <dd>
            Theming should involve changing fewer than a dozen lines of code.
            This means strict variable usage.
          </dd>
