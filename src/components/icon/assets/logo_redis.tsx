...
const EuiIconLogoRedis = ({
  ...
  >
    ...
    <g fill="none" transform="translate(0 3)">
      ...
      />
      <ellipse cx={9.541} cy={6.311} fill="#FFF" rx={3.92} ry={1.51} />
      <path fill="#7A0C00" d="m23.398 4.386 4.34 1.705-4.336 1.703z" />
      <path fill="#AD2115" d="m18.596 6.274 4.802-1.888.004 3.408-.471.183z" />
    </g>
  </svg>
);
