import figmaModalConfirmingAnAction from './assets/modal_confirming-an-action.webp';
import figmaModalConfirmingADestructiveAction from './assets/modal_confirming-a-destructive-action.webp';
