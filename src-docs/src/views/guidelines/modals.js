...
amount of content and getting them to make a decision.
    ...
    <EuiFlexGroup wrap={true}>
      ...
      <EuiFlexItem >
        ...
        <EuiText>
          <h4><strong>The header sets the context for the user</strong></h4>
          ...
          <h4><strong>An overlay is optional</strong></h4>
    ...
    <GuideRuleTitle>Usage</GuideRuleTitle>
      ...
      <EuiFlexItem style={{ minWidth: 300 }}>
        <EuiPanel paddingSize="l">
          <EuiText>
            ...
            <p>Modals pull users out of their current context.
      ...
      <EuiFlexItem style={{ minWidth: 300 }}>
        ...
        <EuiPanel paddingSize="l">
          <EuiText>
            ...
            <p>A modal should be a short, direct conversation with the user.
              ...
              <EuiLink
                href="https://elastic.github.io/eui/#/forms/form"
              >
                      form
              </EuiLink>.
            </p>
      ...
      <EuiFlexItem style={{ minWidth: 300 }}>
        <EuiPanel paddingSize="l">
          <EuiText>
            ...
            <p>Don&apos;t just pop open a modal. Let a user action, such as clicking a button, trigger a modal.</p>
          </EuiText>
        </EuiPanel>
      </EuiFlexItem>
    </EuiFlexGroup>

    <GuideRuleTitle>Content</GuideRuleTitle>


    <GuideRule
      description="The header directs users' attention to the task, and the body contains the text and components to support it.
          Button text should always reinforce the header."
    >
      <GuideRuleExample
        panel={false}
        type="do"
        text="Do. Pare down the content to just the essential elements. Match the header and button text."
      >
        <div style={{ textAlign: 'center' }}>
      ...
      <GuideRuleExample
        type="dont"
        panel={false}
        text="Don't start with a vague header such as &quot;Are you sure?&quot;
        It doesn't add value and makes the header longer.
    ...
    <GuideRule
      description="The most common use of a modal in the EUI Framework is to ask the user to confirm an action."
    >
      ...
      <GuideRuleExample
        panel={false}
        type="dont"
        text="Don't use a modal for a message.  Use a toast for a success message because it is less disruptive.
    ...
    <GuideRule
      description="For readability, create separate confirmations for single and bulk actions.
      It avoids the awkwardness of &quot;Delete 1 pipeline(s)&quot;."
    >
      <GuideRuleExample
        panel={false}
        type="do"
    ...
    <GuideRuleTitle>Simple input modal</GuideRuleTitle>


    <GuideRule
      description="Keep an input modal to a simple task that doesn't require a lot of explanatory information or user interaction."
    >
    ...
    <EuiFlexGroup wrap={true}>
      <EuiFlexItem style={{ minWidth: 300 }}>
        <EuiPanel paddingSize="l">
          <EuiText>
            <h3>Scrolling</h3>
            <p>Modal content should fit in a single screen.
      ...
      <EuiFlexItem style={{ minWidth: 300 }}>
        ...
        <EuiPanel paddingSize="l">
          <EuiText>
            ...
            <p>Using a modal on top of a modal typically means your workflow is too complex&mdash;users shouldn&apos;t have
              ...
              >
                    ...
                    &nbsp;or&nbsp;
              <EuiLink
                href="https://elastic.github.io/eui/#/navigation/steps"
              >
                        steps
              </EuiLink>
                  .
