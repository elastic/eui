  ...
  describe('shouldComponentUpdate', () => {
    ...
    describe('should return true', () => {
      ...
      describe('when state changes:', () => {
        it('cellProps', () => {
          act(() => component.setState({ cellProps: {} }));
        });
        it('isEntered', () => {
          act(() => component.setState({ isEntered: true }));
        });
        it('isFocused', () => {
          act(() => component.setState({ isFocused: true }));
        });
        it('enableInteractions', () => {
          act(() => component.setState({ enableInteractions: true }));
        });
        it('disableCellTabIndex', () => {
          act(() => component.setState({ disableCellTabIndex: true }));
        });
      });
    });
