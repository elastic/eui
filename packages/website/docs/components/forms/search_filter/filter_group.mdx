---
slug: /forms/search-filter/filter-group
id: forms_filter_group
sidebar_position: 3
---
...
To provide a long list of grouped filters, we recommend wrapping the filter button within an [**EuiPopover**](/docs/layout/popover) and passing the items to a searchable [**EuiSelectable**](/docs/forms/selection/selectable/).
