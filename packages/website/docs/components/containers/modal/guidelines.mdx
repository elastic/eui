---
slug: /containers/modal/guidelines
id: containers_modal_guidelines
title: Modal guidelines
sidebar_label: Guidelines
sidebar_position: 3
---

import { EuiPanel, EuiModalHeader, EuiModalHeaderTitle, EuiModalBody, EuiModalFooter, EuiButton, EuiButtonEmpty, EuiText, EuiFieldText, EuiFlexGroup, EuiFormRow, EuiSpacer, EuiTextArea, EuiTitle } from '@elastic/eui';

A modal says “pay attention to me and nothing else.”

<EuiPanel color="subdued" paddingSize="l" hasShadow={false} style={{ justifyContent: 'center', display: 'flex' }}>
...
**The header sets the context**<br /> Short and sentence-case, the header should indicate what the modal is about.

**The body is for a single task**<br /> This task should not require a lot of explanation or user interaction.

**Buttons are right-aligned**<br /> The primary action is a filled button, and the secondary action is a link button. Labels should use strong action verbs.
...
<EuiFlexGroup gutterSize="m">
  <Guideline type="do" text="A save action is a good use case for a modal. The meaning is clear and the content is simple." panelPadding="m" panelStyle={{ minHeight: 452, display: 'flex', alignItems: 'center' }}>
    <EuiPanel
      paddingSize="none"
  ...
  <Guideline type="dont" text="Modals aren't the best design solution for multiple steps or complex user input. An in-page form is more appropriate." panelStyle={{ minHeight: 452, display: 'flex', alignItems: 'center' }}>
    <EuiPanel
      paddingSize="none"
      style={{ maxWidth: 400, transform: 'scale(.75)' }}
    >
...
**Open a modal on a user action**<br />Let a user action, such as a button click, open a modal. Don't open a modal from a toolbar action—users don't expect it.

**Avoid scrolling content**<br />Modal content should fit in a single view. If your modal has a lot of detail or a long list of items, consider a different solution, such as a form or a table.

**Don't stack modals**<br />Opening a modal on top of a modal might mean your workflow is too complex. Instead, use a component that supports multiple steps, such as a form or steps.
...
<EuiFlexGroup gutterSize="m">
  <Guideline
    type="do"
    panelPadding="m"
    panelStyle={{ minHeight: 298, display: 'flex', alignItems: 'center' }}
    text="Use a modal for confirmation when the user might lose data. For the body text, use one to two short sentences that explain the consequences."
  >
    <EuiPanel
      paddingSize="none"
      style={{ maxWidth: 400, transform: 'scale(.75)' }}
  ...
  <Guideline
    type="dont"
    panelStyle={{ minHeight: 298, display: 'flex', alignItems: 'center' }}
    text="Confirmations aren't good for messages. Toasts are best for success messages because they are less disruptive. Error and warning messages often appear directly on the page."
  >
    <EuiPanel
      paddingSize="none"
      style={{ maxWidth: 400, transform: 'scale(.75)' }}
...
<EuiFlexGroup gutterSize="m">
  <Guideline
    type="do"
    panelPadding="m"
    panelStyle={{ minHeight: 334, display: 'flex', alignItems: 'center' }}
...
<EuiFlexGroup gutterSize="m">
  <Guideline
    type="do"
    panelPadding="m"
    panelStyle={{ minHeight: 270, display: 'flex', alignItems: 'center' }}
    text="Asking users to delete a single item should include the item name in the title, if possible. Use single quotes around the name if it helps clarify meaning."
  >
    <EuiPanel
      paddingSize="none"
      style={{ maxWidth: 400, transform: 'scale(.75)' }}
...
<EuiFlexGroup gutterSize="m">
  <Guideline
    ...
    panelPadding="m"
    panelStyle={{ minHeight: 270, display: 'flex', alignItems: 'center' }}
    text="Here the header and body are enough. The modal asks the user whether to remove an index pattern &mdash; data won't be lost."
  >
    <EuiPanel
      paddingSize="none"
      style={{ maxWidth: 400, transform: 'scale(.75)' }}
