...
*   `onChange`
    ...
    *   Can be used to store and preserve user display preferences on page refresh - see this [data grid styling and control example](/docs/tabular-content/data-grid/style-and-display#adjusting-your-grid-to-usertoolbar-changes).
*   `scrollAnchorRow`
