...
<Example.Snippet>
  ```tsx
    // setup file
    import { setupEuiCypressMatchers } from '@elastic/eui/test-env/test/cypress/matchers';
...
<Example.Snippet>
  ```tsx
    // setup file
    import { setupEuiEnzymeMatchers } from '@elastic/eui/test-env/test/enzyme/enzyme_matchers';
