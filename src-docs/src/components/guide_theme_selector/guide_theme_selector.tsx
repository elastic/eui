...
export const GuideThemeSelector: React.FunctionComponent<React.PropsWithChildren<
...
const GuideThemeSelectorComponent: React.FunctionComponent<React.PropsWithChildren<
  GuideThemeSelectorProps
