---
slug: /navigation/key-pad-menu
id: navigation_key_pad_menu
---
...
:::warning If the menu provides navigation for your application, wrap the EuiKeyPadMenu with <nav aria-label="Nav title"></nav>.
