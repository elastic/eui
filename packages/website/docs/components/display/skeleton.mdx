...
As an optional escape hatch, `ariaLiveProps` is also available and accepts any [**EuiScreenReaderLive**](../../getting-started/utilities/accessibility/overview.mdx#screen-reader-live-region) props.
