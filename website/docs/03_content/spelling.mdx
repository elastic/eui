...
In American English, verbs that end with 'ize' will end with 'ize' or 'ise' in British English. Similary, verbs that end with 'yze' in American English will end with 'yse' in British English. 
