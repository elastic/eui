...
As an optional escape hatch, `ariaLiveProps` is also available and accepts any [**EuiScreenReaderLive**](../../utilities/accessibility/index.mdx#screen-reader-live-region) props.
