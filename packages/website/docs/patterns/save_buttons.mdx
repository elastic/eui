---
id: patterns_save_buttons
slug: /patterns/save-buttons
---
...
The save button should be the most dominant action in the view. By using our primary color and `fill` prop, it insures we keep these consistent whereever it is placed.  
...
The choice of the icon can also be difficult here.  We have used a `disk` icon and a `check` icon with Save buttons within our UIs, but the meaning of these icons can be confusing.  So our recommendation is to avoid the inconsistency here and rely soley on the label.
