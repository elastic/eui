...
const EuiIconSecuritySignalResolved = ({ title, ...props }) => (
  <svg
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M16 12.5a3.5 3.5 0 11-7 0 3.5 3.5 0 017 0zm-1.646-1.354a.5.5 0 010 .707l-2 2a.5.5 0 01-.708 0l-1-1a.5.5 0 01.708-.707l.646.647 1.646-1.647a.5.5 0 01.708 0z"
    />
  </svg>
);
