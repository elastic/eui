...
* Sighted mouse users will be able to briefly hover over the truncated text and read the full text in a tooltip. Use `toolTipProps` to customize it, e.g. its `position`.
