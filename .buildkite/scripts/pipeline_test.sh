...
case $TEST_TYPE in
  ...
  unit:ts)
    ...
    YARN_COMMAND="yarn test-unit --node-options=--max_old_space_size=2048 --testMatch=non-react"
    ;;
  ...
  unit:tsx:16)
    ...
    YARN_COMMAND="yarn test-unit --node-options=--max_old_space_size=2048 --react-version=16 --testMatch=react"
    ;;
  ...
  unit:tsx:17)
    ...
    YARN_COMMAND="yarn test-unit --node-options=--max_old_space_size=2048 --react-version=17 --testMatch=react"
    ;;
  ...
  unit:tsx)
    ...
    YARN_COMMAND="yarn test-unit --node-options=--max_old_space_size=2048 --testMatch=react"
    ;;
  ...
  cypress:16)
    ...
    YARN_COMMAND="yarn cypress install && yarn test-cypress --node-options=--max_old_space_size=2048 --react-version=16"
    ;;
  ...
  cypress:17)
    ...
    YARN_COMMAND="yarn cypress install && yarn test-cypress --node-options=--max_old_space_size=2048 --react-version=17"
    ;;
  ...
  cypress:18)
    ...
    YARN_COMMAND="yarn cypress install && yarn test-cypress --node-options=--max_old_space_size=2048"
    ;;
...
docker compose "${DOCKER_OPTIONS[@]}" run "${YARN_COMMAND}"
