...
EUI provides the following common palettes for quantitative data and [charts](https://eui.elastic.co/#/elastic-charts/creating-charts). Just pass in the number of steps needed and the function will interpolate between the colors.
