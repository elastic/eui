...
export const GuideRuleExample = ({ children, className, type, text, panel, frame, ...rest }) => {
  ...
  return (
    <EuiFlexItem component="figure" className={classes} {...rest}>
      <ChildrenComponent className="guideRule__example__panel">{children}</ChildrenComponent>
