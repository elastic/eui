...
You can use `listProps.truncationProps` and almost any prop that [**EuiTextTruncate**](../../../getting-started/utilities/text_truncation.mdx) accepts to configure this behavior. This can be configured at the **EuiSelectable** level, as well as by each individual option.
