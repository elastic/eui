...
import { typeToPathMapSynonyms as iconSynonyms } from '../../../../../eui/src/components/icon/icon_map';

<Demo scope={{ iconTypes, filterIconTypes, iconSynonyms }} extraFiles={{ 'icon_types.ts': iconTypesSource, 'icon_filter.ts': iconFilterSource }}>
  ```tsx
