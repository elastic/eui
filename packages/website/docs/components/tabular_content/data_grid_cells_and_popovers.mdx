---
slug: /tabular-content/data-grid/cells-and-popovers
id: tabular_content_data_grid_cells_popovers
---
...
Each data grid cell will automatically render an expand action button and an expansion popover ([which can be disabled](/docs/tabular-content/data-grid/cells-and-popovers#disabling-cell-expansion-popovers)). For cells with overflowing or truncated content, this expansion popover helps display the full amount of content, or can be customized to show extra details.
...
To close a cell's expansion popover upon clicking an action, use the [closeCellPopover](/docs/tabular-content/data-grid-advanced#ref-methods) API available via the `ref` prop.
