...
These guidelines are intended for all content authors. This page shares common tips and tricks for writing accessible UI copy. It is not exhaustive and does not replace the official
...
✔️ **Add alt text for all images, icons and media files.** Screen readers, Braille output devices, and search engines love concise, accurate alt text that describe what cannot always be displayed, viewed or heard on screen. 
