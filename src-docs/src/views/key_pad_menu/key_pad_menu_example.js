...
import { EuiCode, EuiKeyPadMenu, EuiKeyPadMenuItem } from '../../../../src/components';
  ...
  sections: [
    {
      ...
      text: (
        <p>
          The KeyPadMenu component presents KeyPadMenuItems in a tiled format, with a fixed width
          which will accommodate three items and then wrap.
        </p>
      ),
