...
import { EuiCode, EuiContextMenu } from '../../../../src/components';
  ...
  sections: [
    {
      ...
      text: (
        <p>
          <EuiCode>EuiContextMenu</EuiCode> is a nested menu system useful for navigating
          complicated trees. It lives within a <EuiCode>EuiPopover</EuiCode>
    ...
    },
    {
      ...
      text: (
        <p>
          Context menus can be used for simple, non-nested menus as well. The below pagination
          example has no nesting and no title.
        </p>
      ),
      demo: <SinglePanel />,
    },
