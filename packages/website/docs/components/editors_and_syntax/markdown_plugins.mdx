...
## Link validation & security[](/docs/editors-syntax/markdown-plugins#link-validation-security)
...
## Putting it all together: a simple chart plugin[](/docs/editors-syntax/markdown-plugins#putting-it-all-together-a-simple-chart-plugin)
