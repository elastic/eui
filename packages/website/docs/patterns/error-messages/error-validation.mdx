...
Use the [EuiFormRow](../../components/forms/validation/basic.mdx#EuiFormRow-prop-error) to display the error message alongside the field. Make sure the error message on the field matches the error message in the summary, so it’s obvious which field caused which error.
