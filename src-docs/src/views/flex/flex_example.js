...
export const FlexExample = {
  ...
  intro: (
    <Fragment>
      <EuiCallOut title="Coloring and padding exist for examples only" color="warning">
        <p>
          Padding and background-color are added to all the <EuiCode>FlexItem</EuiCode> components
          on this documentation page for illustrative purposes only. You will need to add padding
          through additional components or classes if you need it.
        </p>
      </EuiCallOut>
  ...
  sections: [
      ...
      text: (
        <div>
          <p>
            ...
            <strong>single row</strong> of content. By default any <EuiCode>FlexItem</EuiCode>{' '}
            within <EuiCode>FlexGroup</EuiCode> will stretch and grow to match their siblings.
          </p>
        </div>
      ),
    ...
    },
    {
      ...
      text: (
        <p>
          You can set <EuiCode>wrap</EuiCode> on <EuiCode>FlexGroup</EuiCode> if it contains{' '}
          <EuiCode>FlexItem</EuiCode>s with minimum widths, which you want to wrap as the container
          becomes narrower.
        </p>
      ),
      demo: (
    ...
    },
    {
      ...
      text: (
        <p>
          Same code as above. Notice that <EuiCode>FlexItem</EuiCode> creates equal width items no
          matter the number of siblings. <EuiCode>FlexGroup</EuiCode> never wraps.
        </p>
      ),
      demo: (
        <div className="guideDemo__highlightGrid">
    ...
    },
    {
      ...
      text: (
        <p>
          <EuiCode>component=&ldquo;span&rdquo;</EuiCode> can be set on <EuiCode>FlexGroup</EuiCode>{' '}
          and/or <EuiCode>FlexItem</EuiCode>.
        </p>
      ),
      demo: (
        <div className="guideDemo__highlightGrid">
    ...
    },
    {
      ...
      text: (
        <p>
          Sometimes you do not want a <EuiCode>FlexItem</EuiCode> to grow. It can be turned off on
    ...
    },
    {
      ...
      text: (
        <p>
          You can specify a number between 1 and 10 for a <EuiCode>FlexItem</EuiCode> to try to take
          up a proportional part of the flex box it is in.
        </p>
      ),
      demo: (
        <div className="guideDemo__highlightGrid">
    ...
    },
    {
      ...
      text: (
        <p>
          <EuiCode>FlexGroup</EuiCode>s can also use <EuiCode>justifyContent</EuiCode> and{' '}
          <EuiCode>alignItems</EuiCode>props that accept normal flex-box paramenters. Below are some
          common scenarios, where you need to separate two items, center justify a single one, or
          center an item vertically. Note the usage of <EuiCode>FlexItem</EuiCode>s with{' '}
    ...
    },
    {
      ...
      text: (
        <p>
          <EuiCode>FlexGrid</EuiCode> is a more rigid component that sets multiple, wrapping rows of
          same width items.
        </p>
      ),
      props: { EuiFlexGrid },
    ...
    },
    {
      ...
      text: (
        <p>
          You can set a <EuiCode>columns</EuiCode> prop to specify anywhere between 2-4 columns. Any
    ...
    },
    {
      ...
      text: (
        <p>
          <EuiCode>FlexGroup</EuiCode> and <EuiCode>FlexGrid</EuiCode> can nest within themselves
          indefinitely. For example, here we turn off the growth on a
    ...
    },
    {
      ...
      text: (
        <p>
          ...
          <EuiCode>FlexGroup</EuiCode> or a <EuiCode>FlexGrid</EuiCode> to adjust the spacing
          between <EuiCode>FlexItem</EuiCode>s.
        </p>
      ),
      demo: (
        <div className="guideDemo__highlightGrid">
    ...
    },
    {
      ...
      text: (
        <p>
          By default <EuiCode>EuiFlexGroup</EuiCode> is responsive. However, often you only want to
          use groups for alignment and margins, rather than layouts. Simply apply the{' '}
          <EuiCode>responsive={`{false}`}</EuiCode> prop to retain a single row layout for the
          group.
        </p>
      ),
      demo: (
