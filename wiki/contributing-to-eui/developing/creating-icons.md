...
- This practice should also be used for any **3rd-party logos**. For a number of reasons, the EUI team has moved away from maintaining a set of 3rd party logos. Please use the custom SVG option going forward.
