...
flowchart
    ...
    EuiFlyout --> |"session = true"|EuiFlyoutMain --> EuiFlyoutManaged --> EuiFlyoutComponent
    EuiFlyout --> |"session = false and rendered inside a managed flyout"|EuiFlyoutChild --> EuiFlyoutManaged
```
