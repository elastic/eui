...
**EuiPanel** is a building block component that provides a container with padding, borders, shadows, and background colors. Use it as a layout helper for containing content or as the foundation for more complex patterns.

:::tip Looking for usage guidance?

For task-oriented recipes like card layouts, content containers, interactive surfaces, and stat blocks, see the [Card layouts pattern](/docs/patterns/layouts/card-layouts) and [Stat blocks pattern](/docs/patterns/layouts/stat-blocks).
