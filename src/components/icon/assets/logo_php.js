...
const EuiIconLogoPhp = ({ title, ...props }) => (
  <svg
    width={32}
    height={32}
    viewBox="0 0 32 32"
    ...
    <g fill="none" fillRule="evenodd" transform="matrix(1 0 0 -1 .026 25.413)">
      <g transform="translate(.592 .86)">
        <mask id="logo_php-b" fill="#fff">
          <use xlinkHref="#logo_php-a" />
        </mask>
        <g fill="url(#logo_php-c)" fillRule="nonzero" mask="url(#logo_php-b)">
      ...
      <mask id="logo_php-e" fill="#fff">
        <use xlinkHref="#logo_php-d" />
      </mask>
      <g mask="url(#logo_php-e)">
        <path
          fill="#777BB3"
          fillRule="nonzero"
      ...
      <mask id="logo_php-g" fill="#fff">
        <use xlinkHref="#logo_php-f" />
      </mask>
      <g fillRule="nonzero" mask="url(#logo_php-g)">
        <path
          fill="#000"
