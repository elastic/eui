---
sidebar_position: 2
slug: /theming/high-contrast-mode
id: theming_high_contrast_mode
...
While it's usually best keep all high contrast mode the same across your app for visual consistency, some instances may benefit from an exaggerated change in contrast. For this you can set **EuiThemeProvider**'s `highContrastMode` to `true`.
