...
Avoid popover inception (popover triggering another popover), and instead use a [EuiContextMenu](../navigation/context-menu.mdx) to swap the popover panel content.
