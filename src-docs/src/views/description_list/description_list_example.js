...
import { EuiCode, EuiDescriptionList } from '../../../../src/components';
  ...
  sections: [
    {
      ...
      text: (
        <p>
          <EuiCode>DescriptionList</EuiCode> is a component for listing pairs of information
          together. You can use the component on its own, passing in an object for the list, or use
          the <EuiCode>EuiDescriptionListTitle</EuiCode> and{' '}
    ...
    },
    {
      ...
      text: (
        <p>
          Using the <EuiCode>align</EuiCode> and <EuiCode>compressed</EuiCode> props you can further
          tailor the look of a description list. This works with column and inline types.
        </p>
      ),
