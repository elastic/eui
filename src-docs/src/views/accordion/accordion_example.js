...
import { EuiAccordion, EuiCode } from '../../../../src/components';
  ...
  sections: [
    {
      ...
      text: (
        <div>
          <p>
            <EuiCode>EuiAccordion</EuiCode> is purposely bare so that you can put whatever styling
            you need on it (see the accordion form example). The only styling we force on you in the
            caret, which gives the user an understaning that the content will open up.
          </p>
          <p>
            A <EuiCode>buttonContent</EuiCode> prop defines the content of the clickable area. On
            click it will expose the children and animate based on the height of those children.
          </p>
          <p>
            For styling needs. Classes can be individually applied with
            <EuiCode>className</EuiCode> (for the accordion entire), and{' '}
    ...
    },
    {
      ...
      text: (
        <p>
          Use the <EuiCode>extraAction</EuiCode> prop to pass an extra action displayed on the right
          of any accordion. Usually this is a delete or button, but can be anything. Note that this
          action is separate from the click state that expands the accordion. This is needed to make
          it accessibile.
        </p>
      ),
      demo: <AccordionExtra />,
    ...
    },
    {
      ...
      text: (
        <p>
          ...
          and <EuiCode>extraAction</EuiCode> as explained above, we can style the accordion in a way
          common for form use.
        </p>
      ),
      demo: <AccordionForm />,
