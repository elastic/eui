 ...
 * - `title` is used for the flyout menu and navigation history.
 *   Should be provided via flyoutMenuProps or will use default "Unknown flyout".
 *   EuiFlyoutHeader will automatically extract and update the title from its children.
