...
- Fixed an accessibility issue where `EuiColorPalettePicker` was not creating n accessible label for its button or listbox ([#5367](https://github.com/elastic/eui/issues/5367))
