...
import { PageComponentsPreviewWrapper, FixedHeightPreviewWrapper } from './preview_wrapper';
```
...
import { PageComponentsPreviewWrapper } from './_preview_wrapper';
...
When using [EuiEmptyPrompt](../../display/empty_prompt/index.mdx) to replace the main contents of your page you will want to use a panel color opposite that of the section color. For example:
