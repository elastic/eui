...
export interface EuiSuperSelectControlProps<T>
  ...
  /**
   * screenReaderId is generated by an `EuiSuperSelect` class attribute, then passed as a prop to `EuiSelectControl`.
   * This generated string creates a semantic label for the div[role="listbox"] that's opened on click or keypress.
   */
