...
- Added `betaBadgeTooltipProps` to `EuiKeyPadMenuItem` to extend the wrapping `EuiToolTip` ([#5515](https://github.com/elastic/eui/pull/5515))
...
- Fixed `EuiKeyPadMenuItem` accessibility issue where there was a nested focusable element ([#5515](https://github.com/elastic/eui/pull/5515))

**Deprecations**

- Deprecated `data-gridcell-id` from `EuiDataGrid` in favor of 4 new and more flexible props - `data-gridcell-column-id`, `data-gridcell-column-index`, `data-gridcell-row-index`, and `data-gridcell-visible-row-index` ([#5541](https://github.com/elastic/eui/pull/5541))

**Breaking changes**

- `EuiKeyPadMenuItem` now wraps itself with `EuiToolTip` when `betaBadgeLabel` is supplied forcing top element style props to be passed via `betaBadgeTooltipProps` ([#5515](https://github.com/elastic/eui/pull/5515))
