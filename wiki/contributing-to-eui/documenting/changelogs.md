...
All upcoming changelogs should go into the `changelogs/upcoming/` directories.

Our release script automatically handles collating these files on new EUI versions and appends a PR link.
...
* Create a new file with the ID/number of the pull request.
  ...
  * Reference [`packages/eui/changelogs/upcoming/_template.md`](/packages/eui/changelogs/upcoming/_template.md) for the canonical section ordering and formatting.
...
* Make sure the entry is as concise as can be.
