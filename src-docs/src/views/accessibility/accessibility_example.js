  ...
  sections: [
    {
      ...
      text: (
        <p>
          You can make interactive elements keyboard-accessible with this component. This is
          necessary for non-button elements and <EuiCode>a</EuiCode> tags without
    ...
    },
    {
      ...
      text: (
        <div>
          <p>
            This class can be useful to add accessibility to older designs that are still in use,
            but it shouldn&rsquo;t be a permanent solution. See{' '}
            {
          ...
          <p>Use a screenreader to verify that there is a second paragraph in this example:</p>
        </div>
      ),
