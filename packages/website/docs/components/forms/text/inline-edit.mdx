...
Customize the read mode by passing `readModeProps`, which accepts any [EuiButtonEmpty](../../navigation/buttons/button.mdx#props) properties.
...
- `editMode.saveButtonProps` accepts any [EuiButtonIcon](../../navigation/buttons/button.mdx#props) properties
- `editMode.cancelButtonProps` accepts any [EuiButtonIcon](../../navigation/buttons/button.mdx#props) properties
