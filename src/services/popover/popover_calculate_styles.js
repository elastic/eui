export function calculatePopoverStyles(wrapperNodeRect, popupNodeRect, position, buffer = 16) {
  ...
  if (position === 'top') {
    styles.top = wrapperNodeRect.top - (popupNodeRect.height + buffer);
    styles.left = wrapperNodeRect.left + (wrapperNodeRect.width / 2) - (popupNodeRect.width / 2);
  } else if (position === 'bottom') {
    styles.top = wrapperNodeRect.top + wrapperNodeRect.height + buffer;
    styles.left = wrapperNodeRect.left + (wrapperNodeRect.width / 2) - (popupNodeRect.width / 2);
  } else if (position === 'right') {
    styles.top = wrapperNodeRect.top - ((popupNodeRect.height - wrapperNodeRect.height) / 2);
