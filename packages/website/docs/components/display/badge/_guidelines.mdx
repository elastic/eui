import figmaBadgeChoosingPreGaBadges from '!url-loader!./assets/badge_choosing-pre-ga-badges.svg';
...
import betaBadges from './beta_badges.png';

<img src={betaBadges} width="320" alt="An example of a beta badge alongside a link to the Explorer feature" />
...
Such badges rely on the [Beta badge EUI component](#beta_badge).
...
| Short label<br/> _For navigation and contextual menus_| <Icon type="flask" title="Technical preview flask icon" />  | <Icon type="beta" title="beta icon" /> | N/A |
...
<FigmaAsset
  url="https://www.figma.com/file/cfQrOpBdUoY5ygigVRwy7N/Release-badges?type=design&node-id=701-4062&mode=design&t=P3UOCVz5MKA8YJyN-0"
  src={figmaBadgeChoosingPreGaBadges}
  title="Showing beta and preview badges in the UI"
/>
