...
if [ -n "$PACKAGE_PATH" ]; then
  ...
  # Search for the changelog file across all packages (backward compatibility)
  changelog_files=$(find packages/*/changelogs/upcoming/ -type f -name "${PR_NUMBER}.md" 2>/dev/null || true)
