...
**EuiStat** is a legacy wrapper component. For new implementations, we recommend using the [Stat blocks pattern](/docs/patterns/layouts/stat-blocks) which provides more flexibility and better accessibility.
...
## Migration to Stat blocks pattern

If you're currently using `EuiStat`, consider migrating to the [Stat blocks pattern](/docs/patterns/layouts/stat-blocks) for better flexibility and consistency:
