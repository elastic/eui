...
import figmaDashboardGoodPracticesStructure from '!url-loader!./assets/dashboard-good-practices_structure.svg';
import figmaDashboardGoodPracticesClosure from '!url-loader!./assets/dashboard-good-practices_closure.svg';
import figmaDashboardGoodPracticesHierarchy from '!url-loader!./assets/dashboard-good-practices_hierarchy.svg';
import figmaDashboardGoodPracticesAspectRatio from '!url-loader!./assets/dashboard-good-practices_aspect-ratio.svg';
import figmaDashboardGoodPracticesPickTheRightChartModel from '!url-loader!./assets/dashboard-good-practices_pick-the-right-chart-model.svg';
import figmaDashboardGoodPracticesRelevance from '!url-loader!./assets/dashboard-good-practices_relevance.svg';
import figmaDashboardGoodPracticesTitles from '!url-loader!./assets/dashboard-good-practices_titles.svg';
import figmaDashboardGoodPracticesMargins from '!url-loader!./assets/dashboard-good-practices_margins.svg';
...
A preliminary research conducted on dashboards made by Elastic customers showed a tendency to relate on one of the following templates when building a monitoring application. Unfortunately, we don't offer (yet) a simplified way to re-created on of these templates but we suggest to take inspiration from one of these four major categories when building your own dashboard, according to your needs and to the goal of your product.

<FigmaAsset
  url="https://www.figma.com/file/ljx7zNE8mIzGtXA39k4dMU/Dashboard-Good-Practices-%5B220%5D?type=design&node-id=1713-24059&mode=design&t=NfN1OtaqWM9sHBJN-4"
  src={figmaDashboardGoodPracticesStructure}
...
<FigmaAsset
  url="https://www.figma.com/file/ljx7zNE8mIzGtXA39k4dMU/Dashboard-Good-Practices-%5B220%5D?type=design&node-id=1713-24245&mode=design&t=NfN1OtaqWM9sHBJN-4"
  src={figmaDashboardGoodPracticesClosure}
...
<FigmaAsset
  url="https://www.figma.com/file/ljx7zNE8mIzGtXA39k4dMU/Dashboard-Good-Practices-%5B220%5D?type=design&node-id=1732-43337&mode=design&t=NfN1OtaqWM9sHBJN-4"
  src={figmaDashboardGoodPracticesHierarchy}
...
<FigmaAsset
  url="https://www.figma.com/file/ljx7zNE8mIzGtXA39k4dMU/Dashboard-Good-Practices-%5B220%5D?type=design&node-id=1732-45544&mode=design&t=NfN1OtaqWM9sHBJN-4"
  src={figmaDashboardGoodPracticesAspectRatio}
...
<FigmaAsset
  url="https://www.figma.com/file/ljx7zNE8mIzGtXA39k4dMU/Dashboard-Good-Practices-%5B220%5D?type=design&node-id=1701-19998&mode=design&t=NfN1OtaqWM9sHBJN-4"
  src={figmaDashboardGoodPracticesPickTheRightChartModel}
  title="Good and bad example of correct chart according to context."
/>
...
<FigmaAsset
  url="https://www.figma.com/file/ljx7zNE8mIzGtXA39k4dMU/Dashboard-Good-Practices-%5B220%5D?type=design&node-id=1732-43797&mode=design&t=NfN1OtaqWM9sHBJN-4"
  src={figmaDashboardGoodPracticesRelevance}
...
<FigmaAsset
  url="https://www.figma.com/file/ljx7zNE8mIzGtXA39k4dMU/Dashboard-Good-Practices-%5B220%5D?type=design&node-id=1732-45159&mode=design&t=NfN1OtaqWM9sHBJN-4"
  src={figmaDashboardGoodPracticesTitles}
...
<FigmaAsset
  url="https://www.figma.com/file/ljx7zNE8mIzGtXA39k4dMU/Dashboard-Good-Practices-%5B220%5D?type=design&node-id=1732-45435&mode=design&t=NfN1OtaqWM9sHBJN-4"
  src={figmaDashboardGoodPracticesMargins}
