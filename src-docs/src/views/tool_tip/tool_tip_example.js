...
import { EuiCallOut, EuiCode, EuiToolTip, EuiIconTip, EuiSpacer } from '../../../../src/components';
  ...
  sections: [
    {
      ...
      text: (
        <p>
          Wrap <EuiCode>EuiToolTip</EuiCode> around any item that you need a tooltip for. The{' '}
          <EuiCode>position</EuiCode> prop will take a suggested position, but will change it if the
          tool tip gets too close to the edge of the screen. You can use the{' '}
          <EuiCode>clickOnly</EuiCode> prop to tell the too tip to only appear on click wrather than
          on hover.
        </p>
      ),
      props: { EuiToolTip },
    ...
    },
    {
      ...
      text: (
        <Fragment>
          ...
          <p>
            It accepts all the same props as <EuiCode>EuiToolTip</EuiCode>. For convenience, you can
            also specify an optional icon <EuiCode>type</EuiCode> prop.
          </p>
        </Fragment>
      ),
