...
:::info Prefer semantic radius tokens

Use `border.radius.inline` (4px), `control` (8px), `panel` (12px), and `container` (16px) for reviewed surfaces. Legacy `small` / `medium` still resolve to 4px until migrated.
