...
Due to the previously mentioned bare styles, it is recommended to place an [EuiSpacer](../layout/spacer/index.mdx) between accordion items. Padding within each accordion item can be applied via the `paddingSize` prop.
