...
:::tip
**EuiSearchBar**'s usage is specific to [Elasticsearch's Query DSL](https://www.elastic.co/guide/en/elasticsearch/reference/current/query-dsl.html) (domain specific language).<br />
