...
For text and typography specific utilities, go to [the Text documentation page](../theming/utilities/typography.mdx).
:::

:::info Responsive utilities have moved

For responsive specific utilities, go to [the Breakpoint utilities page](../theming/utilities/breakpoints.mdx).
:::
