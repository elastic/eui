...
<Example>
  <Example.Description>
    ...
    More guidance is available in the [**Health and Color Pattern**](../../../../patterns/severity/).
...
<EuiTable>
  <EuiTableHeader>
    ...
    <EuiTableHeaderCell>Data vis / severity colors meet 3:1?</EuiTableHeaderCell>
  </EuiTableHeader>
  <EuiTableRow>
  ...
  <EuiTableRow>
    ...
    <EuiTableRowCell>Improved</EuiTableRowCell>
  </EuiTableRow>
  <EuiTableRow>
