...
Checkboxes and radios are are ideal for allowing users to select options among a small list of options, or to [switch settings on/off](./switch.mdx). For longer lists of options, consider using [dropdrown selection](../overview.mdx) components.
