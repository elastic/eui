...
export class EuiContextMenuPanel extends Component {
  ...
  render() {
    const {
      ...
      onClose,
      title,
      onHeightChange, // eslint-disable-line @typescript-eslint/no-unused-vars
      transitionType,
      transitionDirection,
      onTransitionComplete, // eslint-disable-line @typescript-eslint/no-unused-vars
      onUseKeyboardToNavigate, // eslint-disable-line @typescript-eslint/no-unused-vars
      hasFocus, // eslint-disable-line @typescript-eslint/no-unused-vars
      items,
      watchedItemProps, // eslint-disable-line @typescript-eslint/no-unused-vars
      initialFocusedItemIndex, // eslint-disable-line @typescript-eslint/no-unused-vars
      showNextPanel, // eslint-disable-line @typescript-eslint/no-unused-vars
      showPreviousPanel, // eslint-disable-line @typescript-eslint/no-unused-vars
      ...rest
    } = this.props;
    let panelTitle;
