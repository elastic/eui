...
We should do everything we can to [help users to avoid errors](./help-users-avoid-errors.mdx). When an error occurs, we **must** tell the user. You should tell them exactly what went wrong, and any actions they can take to fix it.
...
We have written guidance on [how to write good error messages](./how-to-write-good-error-messages.mdx).
...
Read more about the [error page pattern](./error-page.mdx).
...
Read more about the [error banner pattern](./error-banners.mdx).
...
Read more about the [validation errors pattern](./error-validation.mdx).
...
Read more about the [error warning pattern](./error-warning.mdx).
...
- [400: Bad request](./examples.mdx#400-bad-request)
- [401: Unauthorized](./examples.mdx#401-unauthorized)
- [403: Forbidden](./examples.mdx#403-forbidden)
- [404: Not found](./examples.mdx#404-not-found)
- [408: Request timeout](./examples.mdx#408-request-timeout)
- [410: Gone](./examples.mdx#410-gone)
- [429: Too many requests](./examples.mdx#429-too-many-requests)
- [500: Internal server error](./examples.mdx#500-internal-server-error)
- [502: Bad gateway](./examples.mdx#502-bad-gateway)
- [503: Service unavailable](./examples.mdx#503-service-unavailable)
- [504: Gateway timeout](./examples.mdx#504-gateway-timeout)
- [507: Insufficient storage](./examples.mdx#507-insufficient-storage)
...
- [Confirmation prompts](../../components/containers/modal/index.mdx#confirming-an-action)
- [Content patterns](../../content/index.mdx)
