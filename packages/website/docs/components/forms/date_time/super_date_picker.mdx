...
The following is a demo pattern of how to layout the **EuiSuperDatePicker** alongside Elastic's KQL search bar using [**EuiSearchBar**](/docs/forms/search-filter/search-bar/) and shrinking to fit when the search bar is in focus.
