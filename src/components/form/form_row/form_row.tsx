...
export type FormRowDisplayKeys = 'row'
  | 'rowCompressed'
  | 'columnCompressed'
  | 'center'
  | 'centerCompressed'
...
type ClassNameMap = {
  [key in FormRowDisplayKeys]: string | null
}
const displayToClassNameMap: ClassNameMap = {
  row: null,
...
export class EuiFormRow extends Component<EuiFormRowProps, EuiFormRowState> {
  ...
  render() {
     ...
     */
    let shimDisplay: keyof ClassNameMap
