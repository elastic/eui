...
import { EuiCode, EuiPagination, EuiPaginationButton } from '../../../../src/components';
...
export const PaginationExample = {
  ...
  sections: [
    ...
    },
    {
      ...
      text: <p>The UI simplifies when we have fewer than the maximum number of visible pages.</p>,
      demo: <FewPages />,
    },
    {
    ...
    },
    {
      ...
      text: (
        <p>
          You can use <EuiCode>FlexGroup</EuiCode> to set up this pagination layout, commonly used
          with Tables.
        </p>
      ),
