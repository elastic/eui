...
import figmaTablePaginationSetAReasonableDefault from './assets/table-pagination_set-a-reasonable-default.webp';
import figmaTablePaginationProvideOptionsOf102550100 from './assets/table-pagination_provide-options-of-10-25-50-100.webp';
import figmaTablePaginationPersistChoiceAcrossPages from './assets/table-pagination_persist-choice-across-pages.webp';
import figmaTablePaginationAllowCustomization from './assets/table-pagination_allow-customization.webp';
