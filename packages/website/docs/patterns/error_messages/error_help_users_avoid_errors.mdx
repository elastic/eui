---
id: patterns_error_messsages_avoid
...
Where a specific format is required, follow [content patterns](../../help-content#fields-and-settings) and provide help text to help the user fill it out correctly the first time around.
