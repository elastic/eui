...
import figmaHelpContentShortDefinitions from '!url-loader!./assets/help-content_short-definitions.svg';
import figmaHelpContentForASpecificSettingOrGroup from '!url-loader!./assets/help-content_for-a-specific-setting-or-group.svg';
import figmaHelpContentForAnEntirePageOrApp from '!url-loader!./assets/help-content_for-an-entire-page-or-app.svg';
import figmaHelpContentFieldsAndSettings from '!url-loader!./assets/help-content_fields-and-settings.svg';
import figmaHelpContentAdditionalInformation from '!url-loader!./assets/help-content_additional-information.svg';
import figmaHelpContentSyntaxReferences from '!url-loader!./assets/help-content_syntax-references.svg';
import figmaHelpContentLegendsForGraphsAndTables from '!url-loader!./assets/help-content_legends-for-graphs-and-tables.svg';
...
<FigmaAsset
  url="https://www.figma.com/file/1ryJM0lhbUopALKHwPUhFC/Help-content?type=design&node-id=6-343&mode=design&t=vZqFprizypJOJryZ-0"
  src={figmaHelpContentShortDefinitions}
  title="Short definitions"
/>

**Interaction**
- Question mark icon <Icon type="question" title="question mark in a circle" /> with the `primary` color directly following the term to explain.
...
<FigmaAsset
  url="https://www.figma.com/file/1ryJM0lhbUopALKHwPUhFC/Help-content?type=design&node-id=1-192&mode=design&t=vZqFprizypJOJryZ-0"
  src={figmaHelpContentForASpecificSettingOrGroup}
  title="Help popover with additional context"
/>
...
<FigmaAsset
  url="https://www.figma.com/file/1ryJM0lhbUopALKHwPUhFC/Help-content?type=design&node-id=6-278&mode=design&t=vZqFprizypJOJryZ-0"
  src={figmaHelpContentForAnEntirePageOrApp}
  title="Help flyout with additional information"
/>
...
<FigmaAsset
  url="https://www.figma.com/file/1ryJM0lhbUopALKHwPUhFC/Help-content?type=design&node-id=60-6885&mode=design&t=vZqFprizypJOJryZ-0"
  src={figmaHelpContentFieldsAndSettings}
  title="Different types of help for form controls and fields"
/>
...
<FigmaAsset
  url="https://www.figma.com/file/1ryJM0lhbUopALKHwPUhFC/Help-content?type=design&node-id=617-386&mode=design&t=gMQHqaXMvQB3A4BX-0"
  src={figmaHelpContentAdditionalInformation}
...
<FigmaAsset
  url="https://www.figma.com/file/1ryJM0lhbUopALKHwPUhFC/Help-content?type=design&node-id=65-56594&mode=design&t=o9mXncfMtIGAHvEG-0"
  src={figmaHelpContentSyntaxReferences}
  title="Syntax reference best practices"
/>
...
<FigmaAsset
  url="https://www.figma.com/file/1ryJM0lhbUopALKHwPUhFC/Help-content?type=design&node-id=121-56743&mode=design&t=o9mXncfMtIGAHvEG-0"
  src={figmaHelpContentLegendsForGraphsAndTables}
  title="Legend and definitions for visualizations"
/>

**Interaction**
- Use an explicit text link with the <Icon type="listBullet" title="list icon" /> icon with the `primary` color to indicate a list of definitions.
