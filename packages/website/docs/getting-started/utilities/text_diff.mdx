...
Also, since `rendered` is simple html string, you can wrap it in any contextual element like [EuiText](../../components/display/text.mdx) or [EuiCodeBlock](../../components/editors_and_syntax/).
