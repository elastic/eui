...
export default () => (
  <div>
    ...
    <br/>
    <EuiFacetButton quantity={6} icon={<EuiIcon type="dot" color="secondary" />}>
    ...
    <br/>
    <EuiFacetButton quantity={6} icon={<EuiAvatar size="s" name="Avatar Jones" />}>
      Avatar as icon
    </EuiFacetButton>
    <br/>
    <EuiFacetButton quantity={6} isLoading>Loading</EuiFacetButton>
  </div>
);
