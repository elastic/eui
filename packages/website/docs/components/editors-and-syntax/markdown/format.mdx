...
```
* Linking to a [page with the same current base path](editor)
* Linking to a [page above this current path](../../../templates/page-template)
```
...
[configuring the default plugins](./plugins.mdx#configuring-the-default-plugins).
