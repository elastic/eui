...
Customize the read mode by passing `readModeProps`, which accepts any [**EuiButtonEmpty**](/docs/navigation/button#empty-button) properties.
...
*   `editMode.formRowProps` accepts any [**EuiFormRow**](/docs/forms/form-layouts#form-and-form-rows) properties
*   `editMode.inputProps` accepts any [**EuiFieldText**](/docs/forms/form-controls#text-field) properties
*   `editMode.saveButtonProps` accepts any [**EuiIconButton**](/docs/navigation/button#icon-buttons) properties
*   `editMode.cancelButtonProps` accepts any [**EuiIconButton**](/docs/navigation/button#icon-buttons) properties
