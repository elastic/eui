...
EUI provides the following common palettes for quantitative data and [charts](../../../data_visualization/overview.mdx). Just pass in the number of steps needed and the function will interpolate between the colors.
