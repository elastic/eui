...
import figmaSaveButtonsWhenShouldIUseASaveButton from './assets/save-buttons_when-should-i-use-a-save-button.webp';
import figmaSaveButtonsHowDoIStyleIt from './assets/save-buttons_how-do-i-style-it.webp';
import figmaSaveButtonsAvoidUsingTheDefaultFillForTheButton from './assets/save-buttons_avoid-using-the-default-fill-for-the-button.webp';
import figmaSaveButtonsAvoidUsingTheSuccessColorVariant from './assets/save-buttons_avoid-using-the-success-color-variant.webp';
import figmaSaveButtonsAvoidSizingTheButtonDifferentlyThanSurroundingButtonsOrFormFields from './assets/save-buttons_avoid-sizing-the-button-differently-than-surrounding-buttons-or-form-fields.webp';
import figmaSaveButtonsConsiderIfAnIconIsNecessary from './assets/save-buttons_consider-if-an-icon-is-necessary.webp';
