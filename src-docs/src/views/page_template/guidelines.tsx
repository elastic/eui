...
import { EuiText, EuiSpacer, EuiCode, EuiImage } from '../../../../src';
...
export default () => (
  <>
    <EuiText grow={false}>
      <h2>Converting from legacy layouts</h2>
      <p>
        Try to use as much of the namespaced (e.g.{' '}
        <EuiCode>{'<EuiPageTemplate.Header />'}</EuiCode>) as much as possible.
        This will ensure that top level props are propogated through and
        alignment is kept through the stacking order. You can use the
    ...
    <EuiText grow={false}>
      <h2>When to center content</h2>
      <p>
        Whether or not the page has side navigation, any empty/loading/error
        states that take up the whole page should be vertically and horizontally
        centered using <EuiCode>{'alignment="center"'}</EuiCode> on the
    ...
    <EuiText grow={false}>
      <h2>Error and loading states</h2>
    </EuiText>
