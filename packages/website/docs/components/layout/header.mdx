...
If you're using [EuiPageTemplate](../templates/page_template/overview.mdx), a padding top will be automatically set based on the number of fixed headers on the page. [EuiFlyouts](../containers/flyout/index.mdx) will also automatically account for and sit below fixed headers.
