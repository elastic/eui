---
slug: /content/writing/examples
id: content_writing_examples
...
Label [buttons](../../components/navigation/button/overview.mdx) with their action. Don't use Yes, OK, or Confirm when you can use a verb phrase instead.
...
Be sure to read the [full button guidelines](../../components/navigation/button/guidelines.mdx).

## Callouts

Use [callouts](../../components/display/callout.mdx) to relay informational, success, warning, or error messages related to the content on the page.
...
The best empty state lets users know what is happening, why it is happening, and what to do about it. Here are four types of frequently used [empty prompts](../../components/display/empty_prompt/index.mdx).
...
Be sure to read the [full empty prompt guidelines](../../components/display/empty_prompt/index.mdx#guidelines).

## Labels

Avoid long [labels](../../components/forms/form_layouts/form_label.mdx), but don't sacrifice clarity. If needed, put additional information in help text and tooltips.
...
Use [links](../../components/navigation/link.mdx) to point to detailed information.
...
[Modals](../../components/containers/modal/index.mdx) are typically used for confirmation when the user might lose data.
...
Place hints and instruction outside a [text field](../../components/forms/text/basic.mdx) so it is always visible to the user.
...
Use clear language for [validation](../../components/forms/form_validation/overview.mdx) messages.
...
A common use of [toasts](../../components/display/toast/index.mdx) is as a success message.
...
Be sure to read the [full toast guidelines](../../components/display/toast/index.mdx#guidelines).
