...
import { EuiBadge, EuiCode } from '../../../../src/components';
  ...
  sections: [
    {
      ...
      text: (
        <p>
          Badges are used to focus on important bits of information. Although they will
          automatically space themselves if you use them in a repetitive fashion it is good form to
          wrap them using a <EuiCode>FlexGroup</EuiCode> so that they will wrap when width is
