...
const EuiIconReporter = ({
  ...
  >
    ...
    <path
      ...
      clipRule="evenodd"
    />
    <path d="M1 13a.996.996 0 0 1 .99 1.134l-.005.027a.989.989 0 0 1-.073.246l-.01.023a1.006 1.006 0 0 1-.052.094l-.01.016a1.002 1.002 0 0 1-.166.196l-.016.015A1 1 0 1 1 1 13Zm14 0a1 1 0 1 1-.438 1.898l-.01-.005a1 1 0 0 1-.211-.142l-.016-.015a1.004 1.004 0 0 1-.227-.306l-.011-.023a.993.993 0 0 1-.073-.246l-.004-.027A1 1 0 0 1 15 13Z" />
  </svg>
);
