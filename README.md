...
You should check out our [living style guide][docs], which contains many examples on components in the EUI framework aesthetic, and how to use them in your products. We also have a [FAQ][faq] that covers common usage questions.
