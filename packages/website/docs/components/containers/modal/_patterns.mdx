import figmaModalConfirmingAnAction from '!url-loader!./assets/modal_confirming-an-action.svg';
import figmaModalConfirmingADestructiveAction from '!url-loader!./assets/modal_confirming-a-destructive-action.svg';
...
<FigmaAsset
  url="https://www.figma.com/file/Uo8iRqa0BaLSvD7BlyNqbp/Confirmation-prompts?type=design&node-id=6-343&mode=design&t=LrJcE5JqrDwsT5DX-0"
  src={figmaModalConfirmingAnAction}
  title="Generic confirmation modal"
/>
...
<FigmaAsset
  url="https://www.figma.com/file/Uo8iRqa0BaLSvD7BlyNqbp/Confirmation-prompts?type=design&node-id=501-990&mode=design&t=LrJcE5JqrDwsT5DX-0"
  src={figmaModalConfirmingADestructiveAction}
  title="Confirmation modal for a destructive action"
/>
